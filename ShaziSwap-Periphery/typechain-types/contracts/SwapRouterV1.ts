...
export interface SwapRouterV1Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "WETH"
      | "addLiquidity"
...
export interface SwapRouterV1 extends BaseContract {
  connect(runner?: ContractRunner | null): SwapRouterV1;
  waitForDeployment(): Promise<this>;

  interface: SwapRouterV1Interface;
