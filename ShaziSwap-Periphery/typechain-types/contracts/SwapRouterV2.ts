...
export interface SwapRouterV2Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "WETH"
      | "addLiquidity"
...
export interface SwapRouterV2 extends BaseContract {
  connect(runner?: ContractRunner | null): SwapRouterV2;
  waitForDeployment(): Promise<this>;

  interface: SwapRouterV2Interface;
